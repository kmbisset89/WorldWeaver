...
import io.github.kmbisset89.worldweaver.domain.PlotThreadDraft
...
import io.github.kmbisset89.worldweaver.domain.ReferenceDocDraft
...
import io.github.kmbisset89.worldweaver.domain.SessionDraft
import io.github.kmbisset89.worldweaver.domain.SessionNpcDraftDestination
import io.github.kmbisset89.worldweaver.domain.SessionScene
...
internal class SessionsViewModel(
    ...
    private fun personOptions(): List<SessionsViewState.PersonOption> {
        val campaign = latestPeople.campaignPeople.sortedWith(
            compareBy<io.github.kmbisset89.worldweaver.domain.CampaignPerson> {
